...
# Import the ombucore base settings.
...
SECRET_KEY = 'l-^@wr1=5rmbfvk13rc@a5r-$0ua5dx)1vc!0s3sn@h@1w(7c3'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'forums', 'theme', 'static'),
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'lib', 'ombucore', 'admin', 'templates',),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
